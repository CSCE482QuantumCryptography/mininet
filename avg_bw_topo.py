...
import set_env as set_env

class MyTopo( Topo ):
    "Topology example for host communicating to another host, switch bandwidth ~200Mpbs"
...
def run():
    ...
    set_env.set_env(net.hosts[0])
    set_env.set_env(net.hosts[1])
